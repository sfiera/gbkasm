...
TileMenuCursor:
    INCBIN "out/iconedit/menucursor.2bpp"
...
LayoutBottomBar:
    dk $00, $20, "--------------------\0"
    db $00, $21, " psvy ICON EDIT\0"
    db $00, $22, " qtwz X =\0"
    db $00, $23, " rux｢ Y =\0"

LayoutMenu:
    dk $06, $01, "ICON EDIT\0"
    dk $05, $06, "へんしゅうする\0"
    dh $05, $07, "アイコンのセーブ\0"
    dk $05, $08, "しんきさくせい\0"
    dh $05, $09, "おわる\0"
...
LayoutDescContinue:
    dh $01, $0e, "アイコンパターンをへんしゅうします\0"
    db $ff

LayoutDescNewIcon:
    dk $01, $0e, "げんざいのアイコンパターンをけして\0"
    dh $01, $0f, "あたらしくへんしゅうします\0"
    db $ff

LayoutDescSave:
    dk $01, $0e, "げんざいのアイコンパターンを\0"
    dh $01, $0f, "ファイルにほぞんします\0"
    db $ff

LayoutDescExit:
    dk $01, $0e, "「ＩＣＯＮ　ＥＤＩＴ」を\0"
    dh $01, $0f, "しゅうりょうします\0"
    db $ff

LayoutEnterFileName:
    dk $01, $02, "ほぞんするなまえをにゅうりょくして\0"
    dh $01, $03, "ください\0"
    db $ff

LayoutConfirmFileName:
    dk $01, $02, "このなまえでほぞんしていいですか？\0"
    dh $01, $03, "はい：Ａ　いいえ：Ｂ\0"
    db $ff

LayoutOutOfSpace:
    dk $01, $02, "あきようりょうがたりなくてセーブ\0"
    dk $01, $03, "できませんでした\0"
    dh $01, $04, "ＯＫ：Ａ\0"
    db $ff

LayoutSameFileExists:
    dk $01, $02, "おなじなまえのファイルがあります\0"
    dh $01, $03, "うわがきしてほぞんしてもいいですか？\0"
    dh $01, $04, "はい：Ａ　いいえ：Ｂ\0"
    db $ff
