...
SECTION "ROM Bank $001", ROMX[$4000], BANK[$1]
    ...
    db $00, $00
    db "GB KISS MENU"
    db $20, $00, $00, $00, $82, $82, $44, $44, $28, $28, $10, $10, $28, $28, $44, $44
    db $82, $82, $00, $00, $10, $10, $38, $28, $38, $28, $7c, $44, $7c, $44, $fe, $82
    db $fe, $fe, $00, $00, $38, $38, $7c, $44, $fe, $82, $fe, $82, $fe, $82, $7c, $44
    db $38, $38, $00, $00, $10, $10, $38, $28, $7c, $44, $fe, $82, $7c, $44, $38, $28
    db $10, $10, $00, $00, $38, $38, $7c, $44, $fe, $92, $fe, $aa, $fe, $92, $7c, $44
...
data_01_4c02::
    db "\n"
    db "   «ｺﾉ\n"
    db $fc, $26, $4c, $ca, $00, $ee, $00, $08, $ee, $00, $ff
...
data_01_4c77::
    db "ｴﾘｱ«ﾏﾃﾞｼﾞｭｼﾝｶﾉｳﾃﾞｽ\n"

data_01_4c8a::
    db "«ｼﾞｭｼﾝ»ｴﾘｱ«ｶﾞ ｱｲﾃｲﾏｾﾝ\n"

data_01_4ca0::
    db $08
    db "«ﾂｳｼﾝｦ ﾁｭｳｼｽﾙﾊﾞｱｲﾊ\n"
    db "\n"
    db $10, $42, $00, $fc, $47, $4c, $f0, $00, $ff

data_01_4cbe::
    db $08, $fc, $3c, $4c
    db "ﾄﾞｳｼｦ ｸｯﾂｹﾃ\n"
    db "\n"
    db $10, $41, $00, $fc, $47, $4c, $f0, $00, $ff

data_01_4cd8::
    db $00, $f0, $00, $08, $fc, $26, $4c
    db "ｦ ｵｸｯﾃｲﾏｽ\n"
    db $f0, $00, $10, $f0, $00, $ff
...
data_01_4d5f::
    db $00
    db "«ﾂｳｼﾝｦ ｼｯﾊﾟｲｼﾏｼﾀ\n"
    db $f0, $00, $08, $f0, $00, $10
    db "«ﾓｳｲﾁﾄﾞﾔﾘﾅｵｼﾃｸﾀﾞｻｲ \n"
    db "\n"
    db $ff
...
data_01_4dc6::
    db $00
    db "«ｱｲﾃﾆ ｵﾅｼﾞ\n"
    db $fc, $26, $4c, $b6, $de, $00, $f0, $00, $08
    db "«ｿﾝｻﾞｲｼﾏｽ\n"
    db $f0, $00, $10
    db "«ｳﾜｶﾞｷｼﾏｽｶ?\n"
    db $fc, $34, $4c, $f0, $00, $ff

data_01_4dfa::
    db $10, $f0, $00, $ff

data_01_4dfe::
    db $00, $fc, $57, $4c, $f0, $00, $08
    db "«ｲｸﾂｶ\n"
    db $fc, $26, $4c
    db "«ｦｻｸｼﾞｮｼﾃ\n"
    db $f0, $00, $10, $fc, $69, $4c
    db "ｼﾃｸﾀﾞｻｲ\n"
    db "\n"
    db $ff, $00, $e3
    db "< ｽﾀｰﾄ >\n"
    ...
    db "ｦｼﾞｯｺｳｼﾏｽ »\n"
    db "\n"
    db $ff, $00, $20, $3c, $00, $fc, $26, $4c
    db " ｼﾞｮｳﾎｳ> \n"
    db "\n"
    db $fd
    db "ﾉｼﾞｮｳﾎｳﾃﾞｽ \n"
    db "\n"
    db $ff, $00, $20, $3c, $20, $00, $fc, $26, $4c
    db "ｲﾚｶｴ > \n"
    db "\n"
    db $08
    db "« ｾﾝﾀｸｼﾀ \n"
    ...
    db $10
    db "«  ﾊﾞｼｮｦｲﾚｶｴﾏｽ\n"
    db $ee, $00, $ff, $00, $20, $3c, $20, $00, $fc, $26, $4c
    db "ｿｳｼﾝ > \n"
    db "\n"
    db $fd
    db "ｦｿｳｼﾝｼﾏｽ \n"
...
data_01_4f3b::
    db $00, $ee, $00, $08, $ee, $00, $10, $ee, $00, $02
    db " GB KISS ﾒﾆｭｰ\n"
    db "\n"
    db "»« ﾄｳﾛｸ\n"
    db $fc, $26, $4c
...
data_01_4f85::
    db $00
    db $0f, $20, $20, $ba, $c9, $00
    db $fc, $26, $4c
    db $a6, $b9, $bc, $c3, $00
    db $ee, $00, $08
    db "« ｺｺﾆｼﾞｭｼﾝｼﾏｽｶ?\n"
    db $ee, $00, $10, $e4, $fc, $34, $4c, $ee, $00, $ff
...
data_01_4fc1::
    db $00
    db "«ﾅｲﾌﾞ»ﾃﾞｰﾀ«ﾉ ﾅﾗﾍﾞｶｴﾃﾞ\n"
    db "\n"
    db $08, $fc, $69, $4c
    db "ｼﾏｽ \n"
    db "\n"
    db $10, $fc, $30, $4f, $fc, $34, $4c, $00, $ff
...
data_01_5d33::
    ...
    db $a9, $f5, $30, $00, $f6, $5c, $02, $64, $aa, $30
...
data_01_6535::
    ...
    db $05, $07, "ｿｳｼﾝｽﾙ\n"
    db $05, $08, "ｼﾞｭｼﾝｽﾙ\n"
    db $05, $09, "»ﾎﾟｹﾍﾞﾙ«ﾆｵｸﾙ\n"
    db $05, $0a, "KISS»ﾒﾆｭｰ«ﾆﾓﾄﾞﾙ»\n"
    db $ff
...
data_01_67c2::
    db $04, $01, "«ｺﾉ»ｶｰﾄﾘｯｼﾞ«ﾆｱﾅﾀﾉ\n"
    db $04, $02, "ｼﾞｮｳﾎｳｦﾄｳﾛｸｼﾏｽ\n"
    db $02, $04, "ﾅﾏｴ:\n"
    db $02, $05, "ﾃﾞﾝﾜ:\n"
    db $03, $06, "»ﾒﾓ:\n"
    db $ff
...
data_01_680e::
    db $03, $0a, "«ｺﾉｼﾞｮｳﾎｳﾃﾞｲｲﾃﾞｽｶ?\n"
    db $ff

data_01_6824::
    db $01, $0e, "«ｺﾉｼﾞｮｳﾎｳｦｶｴﾙﾄ,ｽﾍﾞﾃﾉ\n"
    db $01, $0f, "»ﾌｧｲﾙ«ｶﾞｷｴﾏｽｶﾞ､ｲｲﾃﾞｽｶ?\n"
    db $ff
...
Call_001_7227:
    ...
    ld hl, $c600
    ld bc, $0b68
    trap $c0  ; copy $c600 to VRAM (jt02_5de2)
    ld a, $01
    trap $b4
    ld a, $f0
    trap $dc
